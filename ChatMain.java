...
A java program that finds the weather and covid information the user requested on an online chat site through a bot
and finds the information through API and outputs it via a bot.

Ismail Ahmed
UT Dallas - CS 2336.501
 */
...
public class ChatMain {
    public static void main(String[] args) throws Exception {
        String channel = "#botAPI"; // local variable

        MyBot bot = new MyBot(); // start the bot
        bot.setVerbose(true); // enable debugging
        bot.connect("irc.freenode.net"); // connect to the IRC server
        bot.joinChannel(channel); // join the channel

        // send messages to channel
        bot.sendMessage(channel, "Hello, I will find weather and covid-19 information for you.");
        bot.sendMessage(channel, "Please follow the provided format for expected output.");
        bot.sendMessage(channel, "――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――");
        bot.sendMessage(channel, "For weather, enter weather: City Name/ZIP Code");
        bot.sendMessage(channel, "Example: weather: Richardson or weather: New York or weather: 75080");
        bot.sendMessage(channel, "Note: For zip code, so long as you have 'weather' and 5 digits consecutively somewhere, it will accept it.");
        bot.sendMessage(channel, "――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――――");
        bot.sendMessage(channel, "For covid-19 cases, enter covid: State Initial/world/country: Country Code Letters/County FIPS Code");
        bot.sendMessage(channel, "Example: covid: TX or covid: world or covid: country: US or covid: 48085");
        bot.sendMessage(channel, "Note 1: For state, so long as you have 'covid' and 2 upper letters consecutively somewhere, it will accept it.");
        bot.sendMessage(channel, "Note 2: For world, so long as you have 'covid' and 'world' somewhere, it will accept it.");
        bot.sendMessage(channel, "Note 3: For county, so long as you have 'covid' and 5 digits consecutively somewhere, it will accept it.");
    }
}
...
class MyBot extends PircBot
{
    ...
    public MyBot()
    {
        this.setName("FinderBot"); // name the bot uses to join the IRC server
    }

    // this method is called whenever is message is sent
    public void onMessage(String channel, String sender, String login, String hostname, String message)
    {
        apiVal = newFormat.setFormat(message); // set place and get which api to use

        if (apiVal > 0) // if api found
        {
